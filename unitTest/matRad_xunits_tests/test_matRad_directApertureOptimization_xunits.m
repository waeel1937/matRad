...
function testSuite = test_matRad_directApertureOptimization_xunits
...
load('TG119.mat');
    ...
    assert(isequal([resultGUI22.status], [resultGUI12.info.status]));
    assert(isequal([resultGUI22.iter], [resultGUI12.info.iter]));
    % assert(isequal([resultGUI2.cpu], [resultGUI1.info.cpu]));%no compare for double > 3 ziffern
    % assert(isequal([resultGUI2.objective], [resultGUI1.info.objective]));%no compare for double > 3 ziffern
    ...
    assert(isequal([optResult2.status], [optResult1.info.status]));
    assert(isequal([optResult2.iter], [optResult1.info.iter]));
    % assert(isequal([resultGUI2.cpu], [resultGUI1.info.cpu]));%no compare for double > 3 ziffern
    % assert(isequal([resultGUI2.objective], [resultGUI1.info.objective]));%no compare for double > 3 ziffern
