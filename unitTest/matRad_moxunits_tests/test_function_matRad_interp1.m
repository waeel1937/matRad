...
%     assertError( @()  matRad_interp1 (xp',yp',xp',style));
%     assertError( @()  matRad_interp1 (xp',yp',[],style), 'MATLAB:griddedInterpolant:CompVecValueMismatchErrId');
%     assertError( @()  [1 2]*[1 2 3], 'MATLAB:innerdim');
