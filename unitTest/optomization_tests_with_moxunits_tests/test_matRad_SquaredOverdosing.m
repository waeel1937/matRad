...
function test_suite=test_matRad_SquaredOverdosing
...
import DoseObjectives.matRad_SquaredOverdosing
...
r  =  matRad_SquaredOverdosing(dos,42);

% 
% SquaredDev = matRad_SquaredOverdosing.instance();

assertEqual(r.name, 'Squared Overdosing');
...
r  =  matRad_SquaredOverdosing(dos,scal);
